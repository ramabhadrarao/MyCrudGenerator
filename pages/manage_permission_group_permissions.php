...
<div class='card'>
    <div class='card-header'>
        <h3 class='card-title'>Manage Permission Group Permissions</h3>
        <?php if (check_permission('create_manage_permission_group_permissions')): ?>
        <div class='card-actions'>
            <button id='add-permission_group_permissions' class='btn btn-primary'>
    ...
    <div id='permission_group_permissions-form' class='card' style='display: none;'>
        <div class='card-header'>
            <h3 id='form-title' class='card-title'>Add Permission Group Permissions</h3>
        </div>
        <div class='card-body'>
            <form id='permission_group_permissions-form-element'>
                ...
                <div class='mb-3'>
                    <label class='form-label required' for='permission_id'>Permission Id</label>
                    <select id='permission_id' name='permission_id' class='form-select' required>
    ...
    <div class='card-body'>
        <div class='mb-3'>
            <div class='input-icon'>
                ...
                <input type='text' id='search-box' class='form-control' placeholder='Search permission group permissions...'>
            </div>
        </div>
