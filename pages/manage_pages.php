...
<div class='card'>
    <div class='card-header'>
        ...
        <div class='card-actions'>
            <button id='add-pages' class='btn btn-primary'>
    ...
    <div id='pages-form' class='card' style='display: none;'>
        <div class='card-header'>
            <h3 id='form-title' class='card-title'>Add Pages</h3>
        </div>
        <div class='card-body'>
            <form id='pages-form-element'>
                <input type='hidden' id='page_id' name='page_id'>
                <div class='mb-3'>
                    <label class='form-label required' for='page_name'>Page Name</label>
    ...
    <div class='card-body'>
        <div class='mb-3'>
            <div class='input-icon'>
                ...
                <input type='text' id='search-box' class='form-control' placeholder='Search pages...'>
            </div>
        </div>
