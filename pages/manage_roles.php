...
<div class='card'>
    <div class='card-header'>
        ...
        <div class='card-actions'>
            <button id='add-roles' class='btn btn-primary'>
    ...
    <div id='roles-form' class='card' style='display: none;'>
        <div class='card-header'>
            <h3 id='form-title' class='card-title'>Add Roles</h3>
        </div>
        <div class='card-body'>
            <form id='roles-form-element'>
                <input type='hidden' id='role_id' name='role_id'>
                <div class='mb-3'>
                    <label class='form-label required' for='role_name'>Role Name</label>
    ...
    <div class='card-body'>
        <div class='mb-3'>
            <div class='input-icon'>
                ...
                <input type='text' id='search-box' class='form-control' placeholder='Search roles...'>
            </div>
        </div>
