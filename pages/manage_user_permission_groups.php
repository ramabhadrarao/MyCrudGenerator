...
<div class='container mx-auto mt-8'>
    <h1 class='text-3xl mb-6'>Manage User_permission_groups</h1>

    <div id='user_permission_groups-form' class='hidden bg-white rounded-lg shadow-md p-6 mb-8'>
        <h2 id='form-title' class='text-2xl mb-4'>Add User_permission_groups</h2>
        <form id='user_permission_groups-form-element'>
            ...
            <div class='mb-4'>
                ...
                <select id='user_id' name='user_id' class='w-full border border-gray-300 p-2 rounded select2-dropdown' required>
    ...
    <div class='mb-4'>
        <input type='text' id='search-box' class='w-full border border-gray-300 p-2 rounded' placeholder='Search User_permission_groups...'>
    </div>

    <?php if (check_permission('create_manage_user_permission_groups')): ?>
    <button id='add-user_permission_groups' class='bg-green-500 text-white px-4 py-2 rounded mt-4'>Add User_permission_groups</button>
    <?php endif; ?>
