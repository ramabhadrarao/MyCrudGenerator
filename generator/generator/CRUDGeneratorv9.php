    ...
    private function generateManageJS() {
        ...
        foreach ($this->columns as $column) {
            ...
            if (isset($this->foreignKeys[$column])) {
                ...
                $content .= "                    table += `<th class='border px-4 py-2'>" . ucfirst(str_replace('_', ' ', $foreignField)) . "</th>`;\n";
            } else {
        ...
        foreach ($this->columns as $column) {
            if (isset($this->foreignKeys[$column])) {
                ...
                $foreignField = $this->foreignKeys[$column]['field'];
                $content .= "                        table += `<td class='border px-4 py-2'>\${item.{$foreignField}}</td>`;\n";
            } else {
        ...
        // Fetch related data for foreign key fields using Select2
